...
The chart [][class-histogram] shows how each class is represented in the three
...
In cell 31 I summarized the top_5, with predicted label as rows, true labels as columns,
